...
# while acceptance is done by hand. code_anchors goes stale because of a refactor somewhere else
# and cannot tell a live path from one quoted as obsolete. Both are read by a person.
report:
