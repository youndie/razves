...
|---|---|---|---|---|
| [B-01](docs/backlog/B-01-elf-reader.md) `[ ]` | Read ELF section headers and .symtab without a subprocess | P0 | M | - |
| [B-02](docs/backlog/B-02-reconciliation-invariant.md) `[ ]` | The report cannot be constructed with totals that do not add up | P0 | S | - |
